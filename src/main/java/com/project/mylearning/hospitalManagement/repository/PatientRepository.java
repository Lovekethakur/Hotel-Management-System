...
import com.project.mylearning.hospitalManagement.entity.type.BloodGroupType;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.project.mylearning.hospitalManagement.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
